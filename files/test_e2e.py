...
Edge cases explicitly tested:
  - Zero-defect inspection (clean facade)
  - First-cycle vs. temporal matching cycle
  - Blackbox API failure (warnings surfaced correctly)
  - Confidence threshold filtering
  - DB concurrent write simulation
  - growth_acceleration NULL guard
  - vi_class enum alignment
...
def make_defect(defect_id="B01_C1_0001", severity="moderate",
    ...
    return Defect(
        ...
        contour_geojson={"type": "Feature", "geometry": {"type": "Polygon",
...
class TestSQLiteStore:
    ...
    def test_propagated_defects_query(self, tmp_db):
        ...
        d_c2 = make_defect("B_C2_0001", cx=102.0, cy=101.0,
...
class TestConfidenceFilter:
    def test_below_threshold_excluded(self):
        from pipeline import CONFIDENCE_THRESHOLD, BlackboxDetector
        mock_detections = [
...
class TestE2EPipeline:
    def test_full_run_with_mocked_blackbox(self, synthetic_image, minimal_config,
                                            tmp_path, tmp_db):
        mock_detections = [
